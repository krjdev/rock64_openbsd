...
This is the second stage bootloader. The first stage bootloader is proprietary and resides in the embedded Flash in the used SoC [(Rockchip RK3328)](http://opensource.rock-chips.com/wiki_RK3328).  
